...
public:
	...
	static v8::Local<v8::Promise::Resolver> javaPromiseToJsObject(v8::Isolate* isolate, jobject javaObject);

	static jobject jsObjectToJavaPromise(v8::Isolate* isolate, JNIEnv *env, v8::Local<v8::Object> jsObject);
	static v8::Local<v8::Promise::Resolver> javaPromiseToJsObject(v8::Isolate* isolate, JNIEnv *env, jobject javaObject);
